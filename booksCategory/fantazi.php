        ...
        <div class="row booksrow1">
            ...
            <div class="col-lg-3">
                <div class="card novel">
                    <img src="../images/theravenboys.jpg" alt="Libri 'The Raven Boys' nga Maggie Stiefvater">
                    <div class="padding card-title">
                        <h5 style="font-size: 16px;">The Raven Boys</h5>
                        <p>Autorja: <i><u>Maggie Stiefvater</u></i></p>
                    </div>
                    <div class="padding card-text">
                        <h5>10.99 Eur</h5>
                        <p class="quantity" >Sasia: </p>
                        <p class="quantity sas" id="sasia2">6</p>
            ...
            <div class="col-lg-3">
                <div class="card histori">
                    <img src="../images/thecruelprince.jpg" alt="Libri 'The Cruel Prince' nga Holly Black">
                    <div class="padding card-title">
                        <h5>The Cruel Prince</h5>
                        <p>Autori: <i><u>Holly Black</u></i></p>
                    </div>
                    <div class="padding card-text">
                        <h5>14.99 Eur</h5>
                        <p class="quantity" >Sasia: </p>
                        <p class="quantity sas" id="sasia3">13</p>
            ...
            <div class="col-lg-3">
                <div class="card histori">
                    <img src="../images/shadowandbone.jpg" alt="Libri 'Shadow and Bone' nga Leigh Bardogu">
                    <div class="padding card-title">
                        <h5>Shadow and Bone</h5>
                        <p>Autori: <i><u>Leigh Bardogu</u></i></p>
                    </div>
                    <div class="padding card-text">
                        <h5>19.99 Eur</h5>
                        <p class="quantity" >Sasia: </p>
                        <p class="quantity sas" id="sasia1">9</p>
