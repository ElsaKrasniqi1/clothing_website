        ...
        <div class="row booksrow1">
            ...
            <div class="col-lg-3">
                <div class="card novel">
                    <img src="../images/GjUVdekur.jpg" alt="Libri 'Gjenerali i ushtrisë së vdekur' nga Ismail Kadare">
                    <div class="padding card-title">
                        <h5 style="font-size: 16px;">Gjenerali i ushtrisë së vdekur</h5>
                        <p>Autori: <i><u>Ismail Kadare</u></i></p>
                    </div>
            ...
            <div class="col-lg-3">
                <div class="card histori">
                    <img src="../images/Histori e Gj.Shqipe.jpg" alt="Libri 'Historia e Gjuh♪s shqipe' nga Naim Frashëri">
                    <div class="padding card-title">
                        <h5>Historia e Gjuhës Shqipe</h5>
                        <p>Autori: <i><u>Naim Frashëri</u></i></p>
                    </div>
                    <div class="padding card-text">
                        <h5>9.99 Eur</h5>
                        <p class="quantity" >Sasia: </p>
            ...
            <div class="col-lg-3">
                <div class="card histori">
                    <img src="../images/doruntina.png" alt="Libri 'Kush e solli Doruntinën' nga Ismail Kadare">
                    <div class="padding card-title">
                        <h5>Kush e solli Doruntinën</h5>
                        <p>Autori: <i><u>Ismail Kadare</u></i></p>
                    </div>
                    <div class="padding card-text">
                        <h5>13.99 Eur</h5>
